...
The **Amplify UI Authenticator** is a component that supports several authentication flows using [Amplify Authentication](https://docs.amplify.aws/lib/auth/getting-started/q/platform/ios/).
